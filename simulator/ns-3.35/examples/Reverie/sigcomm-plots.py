...
for alg in algs:
    ...
    for rdmaload in loads:
        ...
        # shortfct = list(tcpshortfctDF["slowdown"])
        # shortfct.sort()
        fct99 = 0#shortfct[int(len(shortfct)*0.99)]
        tcpshortfct99.append(fct99)
...
for alg in algs:
    ...
    ax0.plot(np.arange(len(burststemp)),[i/1000 for i in numpfc],label=names[alg],lw=2,marker=markers[alg],c=colors[alg], markersize=10)
    ax1.plot(np.arange(len(burststemp)),shortfctavg,label=names[alg],lw=2,marker=markers[alg],c=colors[alg], markersize=10)
    ax2.plot(np.arange(len(burststemp)),shortfct95,label=names[alg],lw=2,marker=markers[alg],c=colors[alg], markersize=10)
    ax3.plot(np.arange(len(burststemp)),shortfct99,label=names[alg],lw=2,marker=markers[alg],c=colors[alg], markersize=10)
    ax4.plot(np.arange(len(burststemp)),shortfct999,label=names[alg],lw=2,marker=markers[alg],c=colors[alg], markersize=10)
    ax5.plot(np.arange(len(burststemp)),tcpshortfct99,label=names[alg],lw=2,marker=markers[alg],c=colors[alg], markersize=10)
    ax6.plot(np.arange(len(burststemp)),lossless,label=names[alg],lw=2,marker=markers[alg],c=colors[alg], markersize=10)
    ax7.plot(np.arange(len(burststemp)),lossy,label=names[alg],lw=2,marker=markers[alg],c=colors[alg], markersize=10)
