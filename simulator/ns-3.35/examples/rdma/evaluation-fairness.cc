...
//#endif
		...
		std::string confFile="/home/vamsi/src/phd/PowerTCP-NS3/NS3/src/internet/examples/config-fairness.txt";
...
//	}
	...
	// Simulator::Schedule(Seconds(delay),PrintResults,switchUp,tors,delay);
