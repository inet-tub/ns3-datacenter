...
int main(int argc, char *argv[])
{
    ...
    std::string confFile = "/home/vamsi/src/phd/codebase/ns3-datacenter/simulator/ns-3.35/examples/queueing-devel/config-workload.txt";
    ...
    std::string alphasFile = "/home/vamsi/src/phd/codebase/ns3-datacenter/simulator/ns-3.35/examples/queueing-devel/alphas"; // On lakewood
